...
| 2 | **루틴 분석(2단계)** | [03-workout-step2.png](../design-audit/03-workout-step2.png) | [03-workout-step2.png](03-workout-step2.png) | 무게/반복 머리글을 **목록 위 한 번만**(라벨 24개 → 2개) · 전 종목 같은 값(3세트·RIR 2)은 머리글 옆 한 줄로 · **폴백 루틴에는 "AI 분석 완료" 대신 회색 "기본 루틴"** · 강도 신호등 🟢🟡🔴 제거 |
