...
## 마지막 한 일 (2026-06-14 — 세션 6: 묶음4 GIF/영상 제거 + main 머지·배포)
...
- [x] **묶음4 = GIF/영상 제거로 변경·완료** (858f901, v17 운영 배포). 운동 세션 슬림 카드 유지.
- [ ] **묶음5(화면정리) grill** — 홈·운동·영양·기록 탭 중복·저가치 위젯 제거 범위(per-tab). 이후 6(디자인)
...
_다음 세션 재개: "REMAKE-PLAN.md 읽고 묶음5(화면정리)부터 grill 해줘". (묶음1~4 main 머지·배포 완료, 남은 건 5·6)_
