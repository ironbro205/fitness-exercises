...
var ASSIST_NAME_KEYWORDS = ['어시스트', '어시스티드', '어시스티트'];
...
var WALK_COACH_TIPS = [
  '✋ 손잡이 잡고 있나요? 놓으세요. 잡고 뒤로 기대면 강도의 3분의 1이 날아갑니다.',
  '💬 지금 문장은 말할 수 있는데 노래는 안 되는 정도인가요? 그게 딱 맞습니다.',
  '🦶 보폭을 늘리지 말고 발을 더 자주 놓으세요. 긴 보폭은 허리에 부담이 됩니다.',
  '🧍 가슴은 들고 허리는 곧게. 접히는 곳은 허리가 아니라 고관절입니다.'
];
