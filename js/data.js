...
var COACH_KNOWLEDGE =
  '### 1. 트레이닝 핵심 원리\n' +
  '- 볼륨: 부위당 주 10~20 본세트가 최적 구간. 세트 1개당 약 +0.24% 근비대, 일정 지점 이후 수익 체감 (Pelland 2024). 4세트 미만=부족, 20세트 초과=과잉/회복 부담.\n' +
  ...
  '- 점진적 과부하: 더블 프로그레션이 기본. 목표 횟수 상단을 2세션 연속 달성하면 무게 +2.5~5kg, 횟수는 하단으로 리셋.\n' +
  ...
  '- 정체 시: 무게 +2.5kg 도전, 종목/각도 변경, 볼륨 소폭↑, 또는 디로드 후 재도전 중 하나.\n' +
