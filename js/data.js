...
var COACH_KNOWLEDGE =
  ...
  '- 세트법: 볼륨이 같으면 스트레이트·피라미드·드롭세트의 근비대는 동등 (Angleri 2017 / Sødal 2023 메타 SMD 0.155 p=0.392). 그래서 앱은 "더 좋은 세트법"을 찾지 않고 문제에 맞춰 배정한다 — 고중량 복합만 탑세트(가장 무거운 1세트 뒤 90% 무게로 채운다. 뒤 세트 반복 붕괴로 잃는 볼륨 로드를 보존), 나머지는 스트레이트. 드롭세트의 이득은 오직 시간(1/2~1/3)이라 시간 압박이 있을 때만 제안한다.\n' +
